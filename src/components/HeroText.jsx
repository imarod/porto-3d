...
const HeroText = () => {
  ...
  const textY = useTransform(x, [0, 0.1], ["0%", "500%"])
  return (
    <div className="relative min-h-screen flex items-center justify-center text-center z-20 md:-translate-y-[3vh] -translate-x-0 md:-translate-x-10 ">
      ...
      <div className="flex flex-col md:hidden">
        <motion.h1
          className="font-poster font-black uppercase tracking-tighter leading-none scale-x-120 text-[3.5rem] sm:text-[4.5rem] px-4 -translate-y-[20vh] text-transparent
